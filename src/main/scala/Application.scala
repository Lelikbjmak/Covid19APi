...
import service.impl.{ApiServiceImpl, CountryRetrieveService, CovidDetailsServiceImpl}
...
object Application extends App {
  ...
  private val countryService: CountryRetrieveService = CountryRetrieveService(countryRepository.asInstanceOf[CountryRepository])

  private val apiRoute: ApiRoute = new ApiRoute(covidDetailsService, apiControllerRouteValidator, countryService)
